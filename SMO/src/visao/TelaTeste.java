...
import visao.TelaConsultaMotorista;
/**
 *
 * @author Cassianok
 */
public class TelaTeste extends javax.swing.JFrame {
     ...
     */
    public TelaTeste(DefaultListModel model) {
        initComponents();
        this.model = model;
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTextFieldTeste, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        ...
        model.addElement(jTextFieldTeste.getText());
        TelaConsultaMotorista teste = new TelaConsultaMotorista();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaTeste(null).setVisible(true);
            }
        });
    }
